/**
 * Practically all this code comes from https://observablehq.com/@d3/diverging-bar-chart
 */
function DivergingBarChart(data, {
  x = d => d, // given d in data, returns the (quantitative) x-value
  y = i => i, // given d in data, returns the (ordinal) y-value
  title, // given d in data, returns the title text
  marginTop = 50, // top margin, in pixels
  marginRight = 40, // right margin, in pixels
  marginBottom = 10, // bottom margin, in pixels
  marginLeft = 20, // left margin, in pixels
  width = 650, // outer width of chart, in pixels
  ...
  svg.append("g")
      ...
      .call(g => g.append("text")
          .attr("x", id === "#grantchart" ? xScale(1): xScale(0))
          .attr("y", -32)
